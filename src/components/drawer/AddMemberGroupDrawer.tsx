...
import { TableParams } from '@/pages/CustomerManagement/ListCustomers/index.interface';
import { AutoComplete, Avatar, Button, Checkbox, Drawer, Dropdown, Form, InputNumber, Radio, Select, Space, Table, Typography, notification } from 'antd'
...
function AddMember({
    ...
    const handleAddMemnerToGroup = async (form: any, record: any) => {
        setLoading(true)
        await AddMemberToGroup(form).then((res: any) => {
            if (res.code === 200) {
