...
import { AutoComplete, Col, Form, InputNumber, Radio, Row, Typography, Input, Divider, Alert, Select, Checkbox } from 'antd'
...
function CreateSignal() {
    ...
    const fetchUser = (email: string) => {
        console.log(email);
        axiosInstance.get(`/admin/customer/find/${email}`)
            .then((res) => {
    ...
    return (
        <div>
            <Typography.Title level={2} className='text-center'>Tạo ý tưởng mới</Typography.Title>
            <div>
                    ...
                    <Form>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <Form.Item 
                                    name={subscriptions.length > 0 ? 'subscription_product_id' : ''} label={`Gói dịch vụ`}
                                ...
                                <Form.Item 
                                    name={groups.length > 0 ? 'group_id' : ''} label={`Nhóm khách hàng`}
