...
export const createSignal = async (createData: CreateSignalData) => {
  return axiosInstance.post('/signal/admin/create_signal', createData)
    .then((data) => data)
...
export const approveManySignal = async (data: ApproveSignal) => {
  console.log(data)
  return axiosInstance.post(`/signal/admin/approve_many`, data)
    .then((data) => data)
    .catch((error) => { throw error });
}
export const sendManySignal = async (data: SendManySignal) => {
  console.log(data)
  return axiosInstance.post(`/signal/admin/send_many`, data)
    .then((data) => data)
    .catch((error) => { throw error });
}
